...
<template>
  ...
  <div class=" container" style="margin-top:25px;margin-left:30px;">
    ...
    <el-row :gutter="10">
      <el-col :span="4"><div class="title">竞赛规则: {{ form.contestRules }}</div></el-col>
    </el-row>

    <el-row :gutter="10">
      <el-col :span="4"><div class="text">竞赛人数: {{ form.participantsNumber }}</div></el-col>
    </el-row>
    <el-row :gutter="10">
      <el-col :span="4"><div class="text">竞赛时间: {{ form.contestDate }}</div></el-col>
    </el-row>
    <el-row :gutter="10">
      <el-col :span="4"><div class="title">参与条件: {{ form.participationConditions }}</div></el-col>
    </el-row>
  </div>
